...
class BlogControllerTest extends WebTestCase
{
    ...
    /**
     * This test changes the database contents by creating a new blog element. However,
    ...
    {
        $elementTitle = 'Blog Element Title '.mt_rand();
    ...
    public function testAdminNewDuplicatedElement(): void
    {
        ...
        $this->assertSelectorTextContains('form .form-group.has-error .help-block', 'This title was already used in another blog element, but they must be unique.');
    }
    ...
    /**
     * This test changes the database contents by editing a blog element. However,
     * thanks to the DAMADoctrineTestBundle and its PHPUnit listener, all changes
     * to the database are rolled back when this test completes. This means that
     * all the application tests begin with the same database contents.
     */
    ...
    {
        $newBlogElementTitle = 'Blog Element Title '.mt_rand();
        ...
        $client->submitForm('Save changes', [
            'element[title]' => $newBlogElementTitle,
        ]);
        ...
        $this->assertSame($newBlogElementTitle, $element->getTitle());
    }

    /**
     * This test changes the database contents by deleting a blog element. However,
     * thanks to the DAMADoctrineTestBundle and its PHPUnit listener, all changes
     * to the database are rolled back when this test completes. This means that
     * all the application tests begin with the same database contents.
     */
