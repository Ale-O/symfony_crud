 ...
 */
final class Version20221221190328 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__date_fields AS SELECT id, element_id, subelement_id, title, content, position FROM date_fields');
        $this->addSql('DROP TABLE date_fields');
        $this->addSql('CREATE TABLE date_fields (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, subelement_id INTEGER DEFAULT NULL, element_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL COLLATE BINARY, content DATETIME NOT NULL, position INTEGER NOT NULL, CONSTRAINT FK_9A51DC6B1F1F2A24 FOREIGN KEY (element_id) REFERENCES symfony_element (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9A51DC6B408ECD87 FOREIGN KEY (subelement_id) REFERENCES symfony_subelement (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO date_fields (id, element_id, subelement_id, title, content, position) SELECT id, element_id, subelement_id, title, content, position FROM __temp__date_fields');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__text_fields AS SELECT id, element_id, subelement_id, title, content, position FROM text_fields');
        ...
        $this->addSql('INSERT INTO text_fields (id, element_id, subelement_id, title, content, position) SELECT id, element_id, subelement_id, title, content, position FROM __temp__text_fields');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__date_fields AS SELECT id, element_id, subelement_id, title, content, position FROM date_fields');
        $this->addSql('DROP TABLE date_fields');
        $this->addSql('CREATE TABLE date_fields (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, subelement_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL, content DATETIME NOT NULL, position INTEGER NOT NULL, element_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO date_fields (id, element_id, subelement_id, title, content, position) SELECT id, element_id, subelement_id, title, content, position FROM __temp__date_fields');
        $this->addSql('DROP TABLE __temp__date_fields');
        $this->addSql('CREATE INDEX IDX_9A51DC6B1F1F2A24 ON date_fields (element_id)');
        $this->addSql('CREATE INDEX IDX_9A51DC6B408ECD87 ON date_fields (subelement_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__text_fields AS SELECT id, element_id, subelement_id, title, content, position FROM text_fields');
        $this->addSql('DROP TABLE text_fields');
        $this->addSql('CREATE TABLE text_fields (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, subelement_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL, content VARCHAR(255) NOT NULL, position INTEGER NOT NULL, element_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO text_fields (id, element_id, subelement_id, title, content, position) SELECT id, element_id, subelement_id, title, content, position FROM __temp__text_fields');
        $this->addSql('DROP TABLE __temp__text_fields');
        $this->addSql('CREATE INDEX IDX_6B697A7B1F1F2A24 ON text_fields (element_id)');
        $this->addSql('CREATE INDEX IDX_6B697A7B408ECD87 ON text_fields (subelement_id)');
