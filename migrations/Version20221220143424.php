 ...
 */
final class Version20221220143424 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__text_fields AS SELECT id, element_id, subelement_id, title, content FROM text_fields');
        ...
        $this->addSql('INSERT INTO text_fields (id, element_id, subelement_id, title, content) SELECT id, element_id, subelement_id, title, content FROM __temp__text_fields');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__text_fields AS SELECT id, element_id, subelement_id, title, content FROM text_fields');
        $this->addSql('DROP TABLE text_fields');
        $this->addSql('CREATE TABLE text_fields (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, element_id INTEGER NOT NULL, subelement_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL, content VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO text_fields (id, element_id, subelement_id, title, content) SELECT id, element_id, subelement_id, title, content FROM __temp__text_fields');
        $this->addSql('DROP TABLE __temp__text_fields');
        $this->addSql('CREATE INDEX IDX_6B697A7B1F1F2A24 ON text_fields (element_id)');
        $this->addSql('CREATE INDEX IDX_6B697A7B408ECD87 ON text_fields (subelement_id)');
