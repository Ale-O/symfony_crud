 ...
 */
final class Version20221221191053 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__date_fields AS SELECT id, subelement_id, element_id, title, content, position FROM date_fields');
        ...
        $this->addSql('INSERT INTO date_fields (id, subelement_id, element_id, title, content, position) SELECT id, subelement_id, element_id, title, content, position FROM __temp__date_fields');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE date_fields');
        $this->addSql('CREATE TABLE date_fields (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, element_id INTEGER DEFAULT NULL, subelement_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL, content DATETIME NOT NULL, position INTEGER NOT NULL)');
