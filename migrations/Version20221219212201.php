 ...
 */
final class Version20221219212201 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE text_fields (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, element_id INTEGER NOT NULL, subelement_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL COLLATE BINARY, content VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_6B697A7B1F1F2A24 FOREIGN KEY (element_id) REFERENCES symfony_element (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6B697A7B408ECD87 FOREIGN KEY (subelement_id) REFERENCES symfony_subelement (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
