 ...
 */
final class Version20221222172924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__number_fields AS SELECT id, element_id, subelement_id, title, content, position FROM number_fields');
        $this->addSql('DROP TABLE number_fields');
        $this->addSql('CREATE TABLE number_fields (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, element_id INTEGER DEFAULT NULL, subelement_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL COLLATE BINARY, content INTEGER NOT NULL, position INTEGER NOT NULL, CONSTRAINT FK_EBE1E0891F1F2A24 FOREIGN KEY (element_id) REFERENCES symfony_element (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EBE1E089408ECD87 FOREIGN KEY (subelement_id) REFERENCES symfony_subelement (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO number_fields (id, element_id, subelement_id, title, content, position) SELECT id, element_id, subelement_id, title, content, position FROM __temp__number_fields');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__number_fields AS SELECT id, element_id, subelement_id, title, content, position FROM number_fields');
        $this->addSql('DROP TABLE number_fields');
        $this->addSql('CREATE TABLE number_fields (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, element_id INTEGER DEFAULT NULL, subelement_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL, content INTEGER NOT NULL, position INTEGER NOT NULL)');
        $this->addSql('INSERT INTO number_fields (id, element_id, subelement_id, title, content, position) SELECT id, element_id, subelement_id, title, content, position FROM __temp__number_fields');
        $this->addSql('DROP TABLE __temp__number_fields');
        $this->addSql('CREATE INDEX IDX_EBE1E0891F1F2A24 ON number_fields (element_id)');
        $this->addSql('CREATE INDEX IDX_EBE1E089408ECD87 ON number_fields (subelement_id)');
