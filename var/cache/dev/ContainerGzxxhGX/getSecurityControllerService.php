...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.hiko9G.'] ?? $container->load('get_ServiceLocator_Hiko9G_Service'))->withContext('App\\Controller\\SecurityController', $container));
