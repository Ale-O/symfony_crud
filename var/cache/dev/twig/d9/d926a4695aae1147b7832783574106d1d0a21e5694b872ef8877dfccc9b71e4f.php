...
class __TwigTemplate_f1f71f33184bef943fe96ad01a9b912f8558000512539ce4dad42e7a1584942b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <button type=\"submit\" class=\"";
        ...
        // line 11
        echo twig_escape_filter($this->env, (((isset($context["button_label"]) || array_key_exists("button_label", $context))) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 11, $this->source); })()), $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("label.create_tag"))) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("label.create_tag"))), "html", null, true);
        echo "
    </button>
...
{% if show_confirmation|default(false) %}
    ...
    {{ include('crud/_delete_tag_confirmation.html.twig') }}
{% endif %}
...
{{ form_start(form, {attr: attr|default({})}) }}
    ...
    <button type=\"submit\" class=\"{{ button_css|default(\"btn btn-primary\") }}\">
        <i class=\"fa fa-save\" aria-hidden=\"true\"></i> {{ button_label|default('label.create_tag'|trans) }}
    </button>
