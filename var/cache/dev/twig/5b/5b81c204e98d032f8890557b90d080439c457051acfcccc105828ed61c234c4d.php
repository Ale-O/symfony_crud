...
class __TwigTemplate_5a058a39b5f926a412af22acc798a12d3490f032a5370f14efe96d993e0bd268 extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"modal-dialog modal-lg\">
            <div class=\"modal-content\">
                ...
                <div class=\"modal-body\">
                    {% if controller %}
                        <h3><a href=\"\" target=\"_blank\">{{ 'title.controller_code'|trans }}</a><small class=\"pull-right\">{{ controller.file_path|format_file(controller.starting_line) }}</small></h3>
                        <pre><code class=\"php\">{{ controller.source_code }}</code></pre>
                    {% else %}
                        <h3><a href=\"\">{{ 'title.controller_code'|trans }}</a></h3>
                        <pre><code>{{ 'not_available'|trans }}</code></pre>
                    {% endif %}

                    <h3><a href=\"\" target=\"_blank\">{{ 'title.twig_template_code'|trans }}</a><small class=\"pull-right\">{{ template.file_path|format_file(template.starting_line) }}</small></h3>
