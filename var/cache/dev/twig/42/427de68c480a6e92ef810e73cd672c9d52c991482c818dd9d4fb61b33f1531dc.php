...
class __TwigTemplate_21c7e7ac14fc408b0c95cdf7185abd21e043c945feea583a8a2112c39ddbff3c extends Template
{
    private $source;
    private $macros = [];
...
<form action=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("admin_tag_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["tag"]) || array_key_exists("tag", $context) ? $context["tag"] : (function () { throw new RuntimeError('Variable "tag" does not exist.', 2, $this->source); })()), "id", [], "any", false, false, false, 2)]), "html", null, true);
