...
";
    ...
    <div class=\"section\">
        ";
        // line 189
        echo twig_include($this->env, $context, "admin/crud/_delete_form.html.twig", ["element" => (isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 189, $this->source); })())], false);
        echo "
    </div>
...
{% block main %}
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-4 col-md-offset-2\">
            <a href=\"{{ path('admin_numberfields_new', {elementSlug: element.slug}) }}\" class=\"btn btn-lg btn-block btn-success\">
                <i class=\"fa fa-plus\" aria-hidden=\"true\"></i> {{ 'action.create'|trans }}
            </a>
        </div>
    </div>
