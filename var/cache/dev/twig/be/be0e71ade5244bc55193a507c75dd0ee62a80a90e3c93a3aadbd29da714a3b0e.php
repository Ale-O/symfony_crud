...
class __TwigTemplate_6b4eec8e98d19ecbb02b9510af61a4899d812d720fb5cf3c94715c81c3c6f2de extends Template
{
    private $source;
    private $macros = [];
            ...
            ";
                ...
                ";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                            // line 228
                            echo "                            ";
                            if ((twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 228) || (0 !== twig_compare($context["listener"], (isset($context["previous_event"]) || array_key_exists("previous_event", $context) ? $context["previous_event"] : (function () { throw new RuntimeError('Variable "previous_event" does not exist.', 228, $this->source); })()))))) {
                                // line 229
                                echo "                                ";
                ...
                if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["decision"], "voter_details", [], "any", false, false, false, 337))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["voter_detail"]) {
                        ...
                        echo "</td>
                                            ";
                        // line 345
                        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 345, $this->source); })()), "voterStrategy", [], "any", false, false, false, 345), twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\AccessDecisionManager::STRATEGY_UNANIMOUS")))) {
                            // line 346
                        ...
                        echo "                                            <td class=\"font-normal text-small\">
                                                ";
                        // line 349
                        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["voter_detail"], "vote", [], "array", false, false, false, 349), twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\Voter\\VoterInterface::ACCESS_GRANTED")))) {
                            // line 350
                            echo "                                                    ACCESS GRANTED
                                                ";
                        } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source,                         // line 351
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "C:\\Users\\corbin-a-2\\Downloads\\symfony\\symfony_crud\\vendor\\symfony\\security-bundle\\Resources\\views\\Collector\\security.html.twig");
    }
}
