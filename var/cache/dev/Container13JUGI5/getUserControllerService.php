...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator..1lrpk9'] ?? $container->load('get_ServiceLocator__1lrpk9Service'))->withContext('App\\Controller\\UserController', $container));
