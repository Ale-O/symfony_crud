...
class getSubelementNotificationSubscriberService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\EventSubscriber\\SubelementNotificationSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\SubelementNotificationSubscriber'];
        }

        return $container->privates['App\\EventSubscriber\\SubelementNotificationSubscriber'] = new \App\EventSubscriber\SubelementNotificationSubscriber($a, ($container->services['router'] ?? $container->getRouterService()), ($container->services['translator'] ?? $container->getTranslatorService()), 'anonymous@example.com');
    }
}
