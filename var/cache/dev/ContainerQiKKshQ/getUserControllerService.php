...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.IsIQNJj'] ?? $container->load('get_ServiceLocator_IsIQNJjService'))->withContext('App\\Controller\\UserController', $container));
