 ...
 */
class getSubelementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SubelementRepository' shared autowired service.
     *
     * @return \App\Repository\SubelementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SubelementRepository.php';

        return $container->privates['App\\Repository\\SubelementRepository'] = new \App\Repository\SubelementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
