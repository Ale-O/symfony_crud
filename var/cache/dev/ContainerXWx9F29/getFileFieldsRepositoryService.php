 ...
 */
class getFileFieldsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FileFieldsRepository' shared autowired service.
     *
     * @return \App\Repository\FileFieldsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FileFieldsRepository.php';

        return $container->privates['App\\Repository\\FileFieldsRepository'] = new \App\Repository\FileFieldsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
