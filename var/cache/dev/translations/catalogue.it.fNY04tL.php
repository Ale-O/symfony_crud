...
$catalogue = new MessageCatalogue('it', array (
  'validators+intl-icu' => 
  array (
    'post.blank_summary' => 'Da\' una descrizione al tuo post!',
    'post.blank_content' => 'Da\' un contenuto al tuo post!',
    'post.too_short_content' => 'Il contenuto del post è troppo breve (minimo { limit } caratteri)',
    'comment.blank' => 'Per favore non lasciare in bianco il tuo commento!',
    'comment.too_short' => 'Il commento è troppo breve (minimo { limit } caratteri)',
    'comment.too_long' => 'Il commento è troppo lungo (massimo { limit } caratteri)',
    'comment.is_spam' => 'Il contenuto di questo commento è considerato come spam.',
  ),
  'validators' => 
  array (
  ...
  array (
    ...
    'http_error.name' => 'Errore {status_code, number}',
    'http_error.description' => 'Un errore sconosciuto (HTTP {status_code, number}) ha impedito di completare la richiesta.',
    'http_error.suggestion' => 'Provare a ricaricare la pagina tra poco o <a href="{url}">tornare alla homepage</a>.',
    'http_error_403.description' => 'Non si dispone dei permessi per accedere a questa risorsa.',
    'http_error_403.suggestion' => 'Chiedere a un amministratore di fornire un accesso a questa risorsa.',
    'http_error_404.description' => 'La pagina richiesta non è stata trovata.',
    'http_error_404.suggestion' => 'Verificare di aver scritto correttamente l\'URL o <a href="{url}">tornare alla homepage</a>.',
    'http_error_500.description' => 'Si è verificato un errore interno del server.',
    'http_error_500.suggestion' => 'Provare a ricaricare la pagina tra poco o <a href="{url}">tornare alla homepage</a>.',
    'title.homepage' => 'Benvenuto nell\'applicazione <strong>Symfony Demo</strong>',
    'title.source_code' => 'Codice sorgente usato per effettuare il render di questa pagina',
    'title.controller_code' => 'Codice del controllore',
    'title.twig_template_code' => 'Codice del template Twig',
    'title.login' => 'Accesso sicuro',
    'title.post_list' => 'Lista dei post',
    'title.edit_post' => 'Modifica post #{id, number}',
    'title.add_comment' => 'Aggiungi un commento',
    'title.comment_error' => 'C\'è stato un errore nella pubblicazione del tuo commento',
    'action.show' => 'Mostra',
    'action.show_post' => 'Mostra post',
    'action.show_code' => 'Mostra codice',
    'action.edit' => 'Modifica',
    'action.edit_post' => 'Modifica post',
    'action.save' => 'Salva cambiamenti',
    'action.delete_post' => 'Elimina post',
    'delete_post_modal.title' => 'Sicuro di voler eliminare questo post?',
    'delete_post_modal.body' => 'Non si può annullare questa azione.',
    'label.delete_post' => 'Elimina post',
    'label.cancel' => 'Annulla',
    'action.create_post' => 'Crea un nuovo post',
    'label.create_post' => 'Crea post',
    'label.save_and_create_new' => 'Salva e crea nuovo',
    'action.back_to_list' => 'Ritorna alla lista dei post',
    'action.publish_comment' => 'Pubblica commento',
    'action.sign_in' => 'Accedi',
    'action.browse_app' => 'Naviga nell\'applicazione',
    'action.browse_admin' => 'Naviga nel pannello di controllo',
    'label.title' => 'Titolo',
    'action.close' => 'Chiudere',
    'label.author' => 'Autore',
    'label.author_email' => 'Email dell\'autore',
    'label.username' => 'Nome utente',
    'label.password' => 'Password',
    'label.role' => 'Ruolo',
    'label.content' => 'Contenuto',
    'label.summary' => 'Descrizione',
    'label.published_at' => 'Data pubblicazione',
    'label.tags' => 'Tag',
    'label.actions' => 'Azioni',
    'title.post_new' => 'Creazione post',
    'action.edit_contents' => 'Modifica contenuti',
    'menu.toggle_nav' => 'Navigazione',
    'menu.choose_language' => 'Lingua',
    'menu.post_list' => 'Lista post',
    'menu.back_to_crud' => 'Ritorna al crud',
    'menu.homepage' => 'Homepage',
    'menu.admin' => 'Pannello di controllo',
    'menu.logout' => 'Esci',
    'menu.rss' => 'RSS del crud',
    'menu.search' => 'Ricercare',
    'post.to_publish_a_comment' => 'per pubblicare un commento',
    'post.num_comments' => '{count, plural, one {# commento} other {# commenti}}',
    'post.commented_on' => 'ha commentato il',
    'post.no_comments' => 'Commenta per primo.',
    'post.no_posts_found' => 'Nessun post trovato.',
    'post.created_successfully' => 'Post creato!',
    'post.updated_successfully' => 'Post aggiornato!',
    'post.deleted_successfully' => 'Post eliminato!',
    'post.search_for' => 'Ricercare...',
    'post.search_no_results' => 'Nessun risultato trovato',
    'notification.comment_created' => 'Il post ha ricevuto un commento!',
    'notification.comment_created.description' => 'Il post "{title}" ha ricevuto un nuovo commento. Si può leggere il commento al seguente <a href="{link}">collegamento</a>',
    'help.app_description' => 'Questa è un\'<strong>applicazione demo</strong> creata con il Framework Symfony per illustrare il modo raccomandato per sviluppare applicazioni con Symfony.',
    'help.show_code' => 'Clicca su questo pulsante per mostare il codice sorgente dei <strong>controllori</strong> e <strong>template</strong> usati per effettuare il render di questa pagina.',
    'help.browse_app' => 'Naviga nella <strong>sezione pubblica</strong> dell\'applicazione demo.',
    'help.browse_admin' => 'Naviga nel <strong>pannello di controllo</strong> dell\'applicazione demo.',
    'help.login_users' => 'Prova uno dei seguenti utenti',
    'help.role_user' => 'utente normale',
    'help.role_admin' => 'amministratore',
    'help.reload_fixtures' => 'Se questi utenti non dovessero funzionare, ricarica i dati dell\'applicazione eseguendo questo comando dal terminale:',
    'help.add_user' => 'Se vuoi aggiungere nuovi utenti, esegui quest\'altro comando:',
    'help.more_information' => 'Per altre informazioni, visita la <a href="https://symfony.com/doc">documentazione di Symfony</a>.',
    'rss.title' => 'Symfony Demo crud',
    'rss.description' => 'Post più recenti pubblicati su Symfony Demo crud',
