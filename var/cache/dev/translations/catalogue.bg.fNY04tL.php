...
$catalogue = new MessageCatalogue('bg', array (
  'validators+intl-icu' => 
  array (
    'post.blank_summary' => 'Напишете обобщение на публикацията си!',
    'post.blank_content' => 'Публикацията трябва да има съдържание!',
    'post.too_short_content' => 'Съдержанието на публикацията е прекалено малко ({ limit } минимум символа)',
    'post.too_many_tags' => 'Прекалено много тагове (добави { limit } тага или по-малко)',
    'comment.blank' => 'Моля не оставяйте коментара празен!',
    'comment.too_short' => 'Коментара е пркалено кратък ({ limit } симвала минимум)',
    'comment.too_long' => 'Коментара е прекалено дълъг ({ limit } симвала максимум)',
    'comment.is_spam' => 'Съдържанието на коментара се разглежда като спам.',
  ),
  'validators' => 
  array (
  ...
  array (
    ...
    'mit_license' => 'MIT лиценз',
    'http_error.name' => 'Грешка {status_code, number}',
    'http_error.description' => 'Има неизвестна грешка (HTTP {status_code, number}) , която спира изпълнението на заявката.',
    'http_error.suggestion' => 'Опитайте да заредите тази страница няколко минути по-късно или <a href="{url}">се върни в началната страница</a>.',
    'http_error_403.description' => 'Нямате права за да достъпите този ресурс.',
    'http_error_403.suggestion' => 'Попитайте вашият мениджър или системен администратор да ви позволи достъп до този ресурс.',
    'http_error_404.description' => 'Страницата която търсите не е намерена.',
    'http_error_404.suggestion' => 'Проверете за правописни грешки в URL адреса или <a href="{url}">се върнете в началната страница</a>.',
    'http_error_500.description' => 'Възникна вътрешно сървърна грешка.',
    'http_error_500.suggestion' => 'Опитайте да заредите тази страница отново след няколко минути или <a href="{url}">се върнете в началната страница</a>.',
    'title.homepage' => 'Добре дошли в <strong>Symfony Demo</strong> приложението',
    'title.source_code' => 'Изходен код, използван за изобразяване на тази страница',
    'title.controller_code' => 'Код на контролера',
    'title.twig_template_code' => 'Twig темплейт код',
    'title.login' => 'Сигурен вход',
    'title.post_list' => 'Списък с публикации',
    'title.edit_post' => 'Редактиране на публикация #{id, number}',
    'title.add_comment' => 'Добавяне на коментар',
    'title.comment_error' => 'Възникна грешка докато се публикуваше вашият коментар',
    'action.show' => 'Покажи',
    'action.show_post' => 'Покажи публикацията',
    'action.show_code' => 'Покажи кода',
    'action.edit' => 'Редактирай',
    'action.edit_post' => 'Редактиране на публикация',
    'action.save' => 'Запази промените',
    'action.delete_post' => 'Изтрии публикацията',
    'delete_post_modal.title' => 'Сигурни ли сте, че искате да изтриете тази публикация?',
    'delete_post_modal.body' => 'Това действие не може да бъде отменено.',
    'label.delete_post' => 'Изтрии публикация',
    'label.cancel' => 'Отказ',
    'action.create_post' => 'Нова публикация',
    'label.create_post' => 'Създайте публикация',
    'label.save_and_create_new' => 'Запазване и създаване на нова',
    'action.back_to_list' => 'Върнете се в списъка с публикации',
    'action.publish_comment' => 'Публикуване на коментара',
    'action.sign_in' => 'Вход',
    'action.browse_app' => 'Прегледайте приложението',
    'action.browse_admin' => 'Прегледайте бекенда',
    'label.title' => 'Заглавие',
    'action.close' => 'затварям',
    'label.author' => 'Автор',
    'label.author_email' => 'Автор email',
    'label.username' => 'Потребителско има',
    'label.password' => 'Парола',
    'label.role' => 'Роля',
    'label.content' => 'Съдържание',
    'label.summary' => 'Обобщение',
    'label.published_at' => 'Публикувано на',
    'label.tags' => 'Тагове',
    'label.actions' => 'Деиствия',
    'title.post_new' => 'Създаване на публикация',
    'action.edit_contents' => 'Редактиране',
    'menu.toggle_nav' => 'Превключване на менюто',
    'menu.choose_language' => 'Изберете език',
    'menu.post_list' => 'Списък с публикации',
    'menu.back_to_crud' => 'Назад към блога',
    'menu.homepage' => 'Начална страница',
    'menu.admin' => 'Бекенд',
    'menu.logout' => 'Изход',
    'menu.rss' => 'Блог публикации RSS',
    'menu.search' => 'Търсене',
    'post.to_publish_a_comment' => 'за да публикувате коментар',
    'post.num_comments' => '{count, plural, one {# коментар} other {# коментари}}',
    'post.commented_on' => 'коментирано на',
    'post.no_comments' => 'Бъдете първият, който ще напише коментар към публикациата.',
    'post.no_posts_found' => 'Не са намерени публикации.',
    'post.created_successfully' => 'Публикацията беше създадена успешно!',
    'post.updated_successfully' => 'Публикацията беше редактирана успешно!',
    'post.deleted_successfully' => 'Публикацията беше изтрита успешно!',
    'post.search_for' => 'Търсене за...',
    'post.search_no_results' => 'Няма намерени резултати',
    'notification.comment_created' => 'Публикацията ви получи коментар!',
    'notification.comment_created.description' => 'Вашата публикация "{title}" получи нов коментар. Можете да прочетете коментара, като последвате <a href="{link}">този линк</a>',
    'help.app_description' => 'Това е <strong>примерно приложение</strong> създатено със Symfony Framework за да илюстрира препоръчителния начин за разработка със Symfony.',
    'help.show_code' => 'Кликнете върху този бутон, за да покажете изходния код на <strong>Контролера</strong> и <strong>темплейта</strong> използвани за показването на тази страница.',
    'help.browse_app' => 'Посетете <strong>публичната секция</strong> на примерното приложение.',
    'help.browse_admin' => 'Посетете <strong>административният панел</strong> на примерното приложение.',
    'help.login_users' => 'Опитайте някой от следните потребители',
    'help.role_user' => 'обикновен потребител',
    'help.role_admin' => 'администратор',
    'help.reload_fixtures' => 'Ако тези потребители не работят, презаредете приложението като използвате следната команда от терминала:',
    'help.add_user' => 'Ако искате да създадете нови потребители, изпълнете тази друга команда:',
    'help.more_information' => 'За повече информация, посетете <a href="https://symfony.com/doc">Symfony документацията</a>.',
    'rss.title' => 'Symfony Demo блог',
    'rss.description' => 'Най-новите публикации, публикувани на блога на Symfony Demo',
