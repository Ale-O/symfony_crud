...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'action.delete_subelement' => 'Supprimer le sous-élément',
    ...
    'delete_subelement_modal.title' => 'Êtes-vous sûr de vouloir supprimer ce sous-élément ?',
    ...
    'title.subelement_new' => 'Ajouter un nouveau sous-élément',
    ...
    'element.to_publish_a_subelement' => 'pour rajouter un sous-élément',
    'fields.num_fields' => '{count, plural, one {# champs} other {# champs}}',
    'element.num_subelements' => '{count, plural, one {# sous-élément} other {# sous-éléments}}',
    'element.subelemented_on' => 'ajouté le',
    'fields.no_fields' => 'Aucun champs détecté.',
    'element.no_subelements' => 'Ajouter un premier sous-élément.',
    ...
    'notification.subelement_created' => 'Votre élément a été complété par un sous-élément !',
    'notification.subelement_created.description' => 'Votre élément "{title}" a été complété par un sous-élément. Vous pouvez lire le sous-élément en suivant <a href="{link}">ce lien</a>',
    ...
    'help.subelement_content' => 'Description du sous-élément.',
