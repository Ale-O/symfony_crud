...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'title.post_list' => 'Liste des éléments',
    'title.edit_post' => 'Modifier l\'élément #{id, number}',
    'title.add_comment' => 'Ajouter un sous-élément',
    'title.comment_error' => 'Il y a eu une erreur lors de l\'ajout du sous-élément.',
    'title.edit_user' => 'Modifier l\'utilisateur',
    'title.change_password' => 'Modifier le mot de passe',
    'action.show' => 'Voir',
    'action.show_post' => 'Voir l\'élément',
    'action.show_code' => 'Voir le code',
    'action.edit' => 'Editer',
    'action.edit_post' => 'Modifier l\'élément',
    'action.save' => 'Enregistrer',
    'action.delete_post' => 'Supprimer l\'élément',
    'delete_post_modal.title' => 'Êtes-vous sûr de vouloir supprimer ce sous-élément ?',
    'delete_post_modal.body' => 'Cette action ne peut pas être annulée.',
    'label.delete_post' => 'Supprimer l\'élément',
    'label.cancel' => 'Annuler',
    'label.create_post' => 'Créer un élément',
    'action.create_post' => 'Créer un nouvel élément',
    'label.save_and_create_new' => 'Enregistrer et créer un nouveau',
    'action.back_to_list' => 'Retour à la liste des éléments',
    'action.publish_comment' => 'Ajouter',
    ...
    'title.post_new' => 'Ajouter un nouvel élément',
    ...
    'menu.post_list' => 'Liste des éléments',
    ...
    'post.to_publish_a_comment' => 'pour rajouter un sous-élément',
    'post.num_comments' => '{count, plural, one {# sous-élément} other {# sous-éléments}}',
    'post.commented_on' => 'ajouté le',
    'post.no_comments' => 'Ajouter un premier sous-élément.',
    'post.no_posts_found' => 'Aucun élément trouvé.',
    'post.created_successfully' => 'Elément créé avec succès !',
    'post.updated_successfully' => 'Elément mis à jour avec succès !',
    'post.deleted_successfully' => 'Elément supprimé avec succès !',
    ...
    'notification.comment_created' => 'Votre élément a été complété par un sous-élément !',
    'notification.comment_created.description' => 'Votre élément "{title}" a été complété par un sous-élément. Vous pouvez lire le sous-élément en suivant <a href="{link}">ce lien</a>',
    ...
    'help.post_publication' => 'Sélectionnez une date future pour programmer le rajout de l\'élément.',
    'help.post_content' => 'Utilisez du Markdown pour formater le contenu de l\'élément. Le HTML est également autorisé.',
    'help.comment_content' => 'Les sous-éléments non conformes seront modérés.',
