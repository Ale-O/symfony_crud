...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'title.element_list' => 'Liste des éléments',
    'title.fields_list' => 'Liste des champs',
    ...
    'title.add_subelement' => 'Ajouter un enregistrement',
    'subelement.too_short' => 'Contenu du enregistrement trop court',
    'element.too_short_content' => 'Contenu de l\'élément trop court',
    'title.subelement_error' => 'Il y a eu une erreur lors de l\'ajout du enregistrement.',
    'title.textfields_error' => 'Il y a eu une erreur lors de la modification du champs texte.',
    'title.datefields_error' => 'Il y a eu une erreur lors de la modification du champs date.',
    'title.edit_user' => 'Modifier l\'utilisateur',
    'title.change_password' => 'Modifier le mot de passe',
    'action.show' => 'Voir',
    'action.create_account' => 'Créer son compte',
    'action.show_element' => 'Voir l\'élément',
    'action.show_code' => 'Voir le code',
    'action.edit' => 'Modifier',
    'action.edit_fields' => 'Modifier les champs',
    'action.lock_fields' => 'Vérrouiller les champs',
    'action.level_up' => 'Passer administrateur',
    'action.level_down' => 'Passer utilisateur',
    'action.level_up_successfully' => 'Passage administrateur réussie',
    'action.level_down_successfully' => 'Passage utilisateur réussie',
    'action.edit_element' => 'Modifier l\'élément',
    'action.save' => 'Enregistrer',
    'action.delete' => 'Supprimer',
    'action.undeletable' => 'Non supprimable',
    'action.delete_element' => 'Supprimer l\'élément',
    'action.delete_subelement' => 'Supprimer le enregistrement',
    'delete_modal.title' => 'Êtes-vous sûr de vouloir supprimer ?',
    'delete_element_modal.title' => 'Êtes-vous sûr de vouloir supprimer cet élément ?',
    'delete_subelement_modal.title' => 'Êtes-vous sûr de vouloir supprimer ce enregistrement ?',
    'delete_modal.body' => 'Cette action ne peut pas être annulée.',
    'delete_element_modal.body' => 'La suppression de l\'élément ne peut pas être annulée.',
    'label.delete' => 'Supprimer',
    'label.delete_element' => 'Supprimer l\'élément',
    'label.delete_subelement' => 'Supprimer le enregistrement',
    'label.cancel' => 'Annuler',
    'label.create' => 'Créer',
    'label.create_fields' => 'Créer un champs',
    'label.create_element' => 'Créer un élément',
    'label.create_subelement' => 'Créer un enregistrement',
    'label.create_tag' => 'Créer un tag',
    'label.create_user' => 'Créer un utilisateur',
    'action.create' => 'Créer',
    'action.create_element' => 'Créer un nouvel élément',
    'action.create_subelement' => 'Créer enregistrement',
    'label.save_and_create_new' => 'Enregistrer et créer un nouveau',
    'action.back_to_list' => 'Retour à la liste des éléments',
    'action.back' => 'Retour',
    'action.quick_add_subelement' => 'Création rapide',
    ...
    'label.name' => 'Nom',
    'action.close' => 'Fermer',
    'label.author' => 'Créateur',
    'label.author_email' => 'Mail du créateur',
    ...
    'label.published_at' => 'Ajouter le',
    'label.tags' => 'Tags',
    'label.actions' => 'Actions',
    'title.fields_new' => 'Ajouter un nouveau champs',
    'title.element_new' => 'Ajouter un nouvel élément',
    'title.subelement_new' => 'Ajouter un nouveau enregistrement',
    'title.tag_new' => 'Ajouter un nouveau tag',
    'title.user_new' => 'Ajouter un nouvel utilisateur',
    ...
    'element.to_publish_a_subelement' => 'pour rajouter un enregistrement',
    'fields.num_fields' => '{count, plural, one {# champs} other {# champs}}',
    'element.num_subelements' => '{count, plural, one {# enregistrement} other {# enregistrements}}',
    'element.subelemented_on' => 'ajouté le',
    'fields.no_fields' => 'Aucun champs détecté.',
    'element.no_subelements' => 'Ajouter un premier enregistrement.',
    'element.no_elements_found' => 'Aucun élément trouvé.',
    'tag.no_tags_found' => 'Aucun tag trouvé.',
    'user.no_users_found' => 'Aucun utilisateurs trouvés.',
    'action.created_successfully' => 'Création réussie !',
    'element.created_successfully' => 'Elément créé avec succès !',
    'action.updated_successfully' => 'Mise à jour réussie !',
    'element.updated_successfully' => 'Elément mis à jour avec succès !',
    'action.deleted_successfully' => 'Suppression réussie !',
    'element.deleted_successfully' => 'Elément supprimé avec succès !',
    'subelement.deleted_successfully' => 'Sous-élément supprimé avec succès !',
    'element.search_for' => 'Rechercher...',
    'element.search_no_results' => 'Aucun résultat',
    'user.updated_successfully' => 'Informations mises à jour avec succès !',
    'notification.subelement_created' => 'Votre élément a été complété par un enregistrement !',
    'notification.subelement_created.description' => 'Votre élément "{title}" a été complété par un enregistrement. Vous pouvez lire le enregistrement en suivant <a href="{link}">ce lien</a>',
    'help.app_description' => 'Ceci est un <strong>CRUD</strong> construit avec le framework Symfony.',
    ...
    'help.browse_app' => 'Espace <strong>Public</strong> sans connexion',
    'help.first_connect' => 'Vous n\'avez pas de <strong>compte</strong>',
    'help.browse_admin' => 'Connectez-vous à votre <strong>compte</strong>.',
    ...
    'help.element_summary' => 'Les résumés ne peuvent pas contenir de contenu Markdown ou HTML ; seulement du texte brut.',
    'help.element_publication' => 'Sélectionnez une date future pour programmer le rajout de l\'élément.',
    'help.element_content' => 'Utilisez du Markdown pour formater le contenu de l\'élément. Le HTML est également autorisé.',
    'help.subelement_content' => 'Description du enregistrement.',
    'info.change_password' => 'Après avoir modifié votre mot de passe, vous serez déconnecté de l\'application.',
    'rss.title' => 'Crud de démo Symfony',
