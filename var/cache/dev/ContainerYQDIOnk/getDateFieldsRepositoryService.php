 ...
 */
class getDateFieldsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DateFieldsRepository' shared autowired service.
     *
     * @return \App\Repository\DateFieldsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DateFieldsRepository.php';

        return $container->privates['App\\Repository\\DateFieldsRepository'] = new \App\Repository\DateFieldsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
