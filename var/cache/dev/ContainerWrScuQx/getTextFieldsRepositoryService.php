 ...
 */
class getTextFieldsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TextFieldsRepository' shared autowired service.
     *
     * @return \App\Repository\TextFieldsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TextFieldsRepository.php';

        return $container->privates['App\\Repository\\TextFieldsRepository'] = new \App\Repository\TextFieldsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
