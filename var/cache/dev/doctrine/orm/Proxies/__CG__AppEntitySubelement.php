...
class Subelement extends \App\Entity\Subelement implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Subelement' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Subelement' . "\0" . 'element', '' . "\0" . 'App\\Entity\\Subelement' . "\0" . 'content', '' . "\0" . 'App\\Entity\\Subelement' . "\0" . 'publishedAt', '' . "\0" . 'App\\Entity\\Subelement' . "\0" . 'author', '' . "\0" . 'App\\Entity\\Subelement' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Subelement' . "\0" . 'textfields', '' . "\0" . 'App\\Entity\\Subelement' . "\0" . 'datefields'];
        }
