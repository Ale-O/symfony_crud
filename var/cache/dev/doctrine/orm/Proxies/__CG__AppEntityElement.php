...
class Element extends \App\Entity\Element implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'slug', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'summary', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'content', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'publishedAt', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'author', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'subelements', '' . "\0" . 'App\\Entity\\Element' . "\0" . 'tags'];
        }
